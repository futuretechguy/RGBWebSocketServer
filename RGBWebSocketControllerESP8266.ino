...
#define REDPIN 12   //14  
#define GREENPIN 13   //5  
#define BLUEPIN 15  //12  
...
void setup(void) {
  ...
  wifiManager.setSTAStaticIPConfig(IPAddress(192,168,1,121), IPAddress(192,168,1,1), IPAddress(255,255,255,0));
  wifiManager.autoConnect("AutoConnectAP");
  //======================================================================

  //ArduinoOTA.setPort(8266);
  ArduinoOTA.setHostname("ESP_RGBServer");
...
void loop(void) {
  ArduinoOTA.handle(); //Over the air update
