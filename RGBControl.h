   ...
   -->
        <div class="rTable">
            ...
            <div class="rTableRow">
                ...
                <!--
                <div class="rTableCell" style="width:70px">
                    <label id="oDevice">Fade:</label>
                </div>
                
                <div class="rTableCell" style="text-align:center">
                    <div class="onoffswitch">
                        <input type="checkbox" name="onoffswitch" class="onoffswitch-checkbox" id="myfadeswitch">
                        <label class="onoffswitch-label" for="myfadeswitch">
                            <span class="onoffswitch-inner"></span>
                            <span class="onoffswitch-switch"></span>
                        </label>
                    </div>
    ...
    <div>
        ...
        -->
        <input id="selectedcolor" type="color" style="background-color:white;width:230px; height: 30px" /><br />
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $("#selectedcolor").change(function (evt) {
                evt.preventDefault();
                document.getElementById("selectedcolor").style = "background-color:" + document.getElementById("selectedcolor").value + ";width:230px; height: 30px";
                R = hexToR(document.getElementById("selectedcolor").value);
                G = hexToG(document.getElementById("selectedcolor").value);
                B = hexToB(document.getElementById("selectedcolor").value);
                var message = String.fromCharCode("34") + R*4 + ", " + G*4 + ", " + B*4 + String.fromCharCode("34");
                ws.send(message);
    ...
    <script type="text/javascript">
        ...
        function ProcessMessage(oMsgvalue) {
            ...
            if (isNaN(ored) == false || isNaN(ogreen) == false || isNaN(oblue) == false) {
                ...
                document.getElementById("selectedcolor").value = "#" + rgbToHex(ored, ogreen, oblue);
                document.getElementById("selectedcolor").style = "background-color:" + "rgb(" + ored + "," + ogreen + "," + oblue + ")" + ";width:230px; height: 30px";
                ...
                document.getElementById("selectedcolor").style = "background-color:rgb(0,0,0);width:230px; height: 30px";
